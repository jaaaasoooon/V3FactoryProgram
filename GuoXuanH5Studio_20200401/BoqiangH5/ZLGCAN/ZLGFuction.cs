            ...
            try
            {
                if (ZLGInfo.DevType != (uint)ZLGType.VCI_USBCANFD_100U)
                {
                    ...
                    while (true)
                    {
                        ...
                        if (RaiseZLGRecvDataEvent != null)
                        {
                            //if (byRecvData[0] == 0x10 && byRecvData[0] == 0xA2 && byRecvData[0] == 0x48)
                            //{
                            //    BoqiangH5Repository.CSVFileHelper.WriteLogs("log", "recv", "jieshouMCU");
                            //}
                            ////if (byRecvData[0] == 0xA3)
                            ////{
                            ////    BoqiangH5Repository.CSVFileHelper.WriteLogs("log", "recv", "jieshouEEPROM");
                            ////}
                            ...
                            //BoqiangH5Repository.CSVFileHelper.WriteLogs("log", "博强接收", BitConverter.ToString(byRecvData));//记录所有接收到的消息
                        }
        ...
        public void SingleTransmit(VCI_CAN_OBJ obj)
        {
            try
            {
                if (ZLGInfo.DevType != (uint)ZLGType.VCI_USBCANFD_100U)
                {
                    ...
                    ////if (pSend.Data[0] == 0xA2)
                    ////{
                    ////    BoqiangH5Repository.CSVFileHelper.WriteLogs("log", "fa", "faMCU");
                    ////}
                    ////if (pSend.Data[0] == 0xA3)
                    ////{
                    ////    BoqiangH5Repository.CSVFileHelper.WriteLogs("log", "fa", "faEEPROM");
                    ////}
                    BoqiangH5Repository.CSVFileHelper.WriteLogs("log", "发送", BitConverter.ToString(pSend.Data));
                    //返回实际发送成功的帧数

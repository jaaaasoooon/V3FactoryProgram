...
namespace BoqiangH5.DDProtocol
{
    public class DdProtocol
    {
        ...
        public void DD_PowerOn()
        {
            ...
            //if (cmdBuf[0] == 0xB2 || cmdBuf[0] == 0xB3 || cmdBuf[0] == 0xB4 || cmdBuf[0] == 0xC1 || cmdBuf[0] == 0xC2 || cmdBuf[0] == 0xB5
            //    || cmdBuf[0] == 0xD0 || cmdBuf[0] == 0xD1 || cmdBuf[0] == 0xD2 || cmdBuf[0] == 0xD3 || cmdBuf[0] == 0xD4 || cmdBuf[0] == 0xD5
            //    || cmdBuf[0] == 0xDB || cmdBuf[0] == 0xD6 || cmdBuf[0] == 0xDA || cmdBuf[0] == 0x10)
            {
